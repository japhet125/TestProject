...
public Person(int cc,int ca)
{
this.caloriesConsumed= caloriesConsumed;
this.caloriesAccumulator= caloriesAccumulator;
}
public Person(String name, int birthYear, double weight,double height, char gender, int 
...
return "Passenger [name= %20s" + name + ", birthYear=%4d" + birthYear + ", weight=%10.2f" 
+ weight + ", gender=%c" + gender+ ", numCarryOn=%2d\n" + numCarryOn + ", height=%10.2f" + height + "]";
}
@Override
public int hashCode() {
